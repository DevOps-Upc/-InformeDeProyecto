...
<p><strong><u>Business Outcome</u></strong></br>
  <ol>
      ...
      <li>Vamos a generar dinero implementando 3 servicios de suscripción:</li>
        <ul>
          <li><strong>Plan Estudiante:</strong> Dirigido a estudiantes, el usuario podra pertencer hasta 5 proyectos.</li>
          ...
          <li><strong>Plan Vip:</strong> Este plan quita el limite de proyectos al que se puede pertenecer, ademas permitir el acceso a un repositorio de proyectos desarrollados.</li>
        </ul>
